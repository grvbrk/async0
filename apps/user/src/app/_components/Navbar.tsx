  ...
  return (
    <>
      <header className="sticky top-0 flex h-16 items-center gap-4 border-b px-4 md:px-6 z-10">
        <nav className="w-full flex gap-10 pl-2 text-sm md:pl-4 md:flex md:flex-row md:items-center md:gap-10 lg:gap-12 ">
          {pathname != "/" && (
            <Link
              href="#"
          ...
          <Link
            href="/problems"
            className={`md:block text-muted-foreground transition-colors hover:text-primary ${pathname === "/problems" && "text-primary"}`}
          >
            Problems
          </Link>
          ...
          <Link
            href="/neetcode"
            className={`md:block text-muted-foreground transition-colors hover:text-primary ${pathname === "/neetcode" && " text-primary"}`}
          >
            Neetcode
          </Link>
        </nav>
